...
describe('DynamicComponentService', function () {
    var service;
    beforeEach(function () {
        service = new example_service_1.DynamicComponentService({}, {}, {
            snapshot: {
                params: {
                    'cipherText': {}
                }
    ...
    it('should run #createComponent()', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should run #insertComponent()', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    it('should run #emptyFunction()', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
