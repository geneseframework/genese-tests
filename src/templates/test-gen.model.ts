...
export abstract class TestGen {
    ...
    __getKlassDecorator(klass: Klass): any {
        ...
        Util.__toArray(props).forEach(el => {
...
// import statement mocks;
    ...
    getKlassGetters() {
        return Util.__toArray(this.klass.get('GetAccessor'));
    }


    getKlassMethods() {
        return Util.__toArray(this.klass.get('MethodDeclaration'));
    }


    getKlassProperties() {
        return Util.__toArray(this.klass.get('PropertyDeclaration'))
    ...
    getKlassSetters() {
        return Util.__toArray(this.klass.get('SetAccessor'));
    }
    ...
    getGenerated(ejsData, options: Options): any {
        let generated;
    ...
    writeGenerated (generated, options: Options): void {
